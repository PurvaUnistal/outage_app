...
import 'package:outage_app/features/Report/CreateAlertForm/domain/model/GetLocationSourceModel.dart';
import 'package:outage_app/features/Report/CreateAlertForm/domain/model/GetModuleTypeModel.dart';
import 'package:outage_app/features/Report/CreateAlertForm/domain/model/GetPriorityTypeModel.dart';
...
class CreateAlertFormHelper {
  ...
  static Future<AddIncidentModel?> addIncidentData({
    ...
    Map<String, String> body = {
      ...
      "charge_area_id": "",
      "area_id": "",
      "location_source": locationSource.isEmpty ? "" :locationSource,
      "customer_id": customeId.isEmpty ? "" : customeId,
      "customer_type_data": "",
      ...
      "remarks": "",
      "asset_type_id": assetTypeId.isEmpty ? "" : assetTypeId.toString(),
