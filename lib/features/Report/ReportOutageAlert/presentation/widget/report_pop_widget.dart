...
import 'package:outage_app/features/Report/ReportOutageAlert/domain/bloc/report_alert_state.dart';
...
class ReportPopWidget extends StatelessWidget {
  ...
  Widget _commercialWidget({required FetchReportAlertDataState dataState}) {
    return ListTile(
      leading: Checkbox(
  ...
  Widget _domesticWidget({required FetchReportAlertDataState dataState}) {
    return ListTile(
      leading: Checkbox(
  ...
  Widget _industrialWidget({required FetchReportAlertDataState dataState}) {
    return ListTile(
      leading: Checkbox(
