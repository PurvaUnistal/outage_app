...
part of 'DomesticModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class DomesticDataAdapter extends TypeAdapter<DomesticData> {
  @override
  final int typeId = 5;

  @override
  DomesticData read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, DomesticData obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.imagePath)
